...
hash_thing(_, stem, stem_not_recorded,
           OldHash, _) -> OldHash;
hash_thing(_, leaf, L = #leaf{}, OldHash, CFG) -> 
    leaf:hash(L, CFG);
hash_thing(_, stem, S = #stem{}, OldHash, CFG) -> 
    stem:hash(S).
                      
    

batch_old2(Leaves0, RP, CFG) ->
